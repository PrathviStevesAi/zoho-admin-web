...
export default function MainErrorBoundary({
  ...
  useEffect(() => {
    console.error("Main Group Error Boundary caught an error:", error);
  }, [error]);

  return (
    <div className="flex h-[calc(100vh-80px)] w-full flex-col items-center justify-center bg-transparent p-4 text-center">
